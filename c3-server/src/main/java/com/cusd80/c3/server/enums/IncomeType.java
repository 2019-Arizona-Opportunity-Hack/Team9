...
public enum IncomeType {
    ...
    private static final Map<String, IncomeType> FROM_STRING = new LinkedHashMap<>();
    static {
    ...
    public static class Convert implements AttributeConverter<IncomeType, String> {

        @Override
        public String convertToDatabaseColumn(IncomeType attribute) {
